...
| Arunima Sen                   | Conducting hotspot analysis (most likely using Getis-Ord statistics) to identify clusters of high activity frequency or performance, supporting the generation of spatial insights through heatmaps.                                                  | 40-50          |
